...
model_settings = config(
    ...
    num_members   = 4000,  # increased members for more accurate distribution
    tot_num_steps = 5840    # increased number of steps, early runs nots in eqbm
)
...
def distr_plotter( i : int ):  
    ...
    plt.tight_layout()
    plt.savefig( f'{plot_save_directory}test_distr_plot.png' )
...
def tseries_plotter( i : int):
    ...
    plt.tight_layout()
    plt.savefig( f'{plot_save_directory}test_tseries_plot.png' )
